...
\begin{itemize}
  ...
  There used to be \mintinline{text}{[highlightlines={1,10-13}]} options here but support for it got removed.

  \item With custom line range

  \inputcode{Python}{code/example.py}

  There used to be \mintinline{text}{[firstline=10,lastline=13]} options here but support for it got removed.
